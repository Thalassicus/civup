...
if NotificationTypes.NOTIFICATION_REQUEST_RESOURCE ~= nil then
...
function OnNotificationAdded( Id, type, toolTip, strSummary, iGameValue, iExtraGameData )
	...
	then
		...
		or ( NotificationTypes.NOTIFICATION_REQUEST_RESOURCE ~= nil and type == NotificationTypes.NOTIFICATION_REQUEST_RESOURCE ) then
...
print(string.format("%3s ms loading NotificationPanel.lua", Game.Round((os.clock() - startClockTime)*1000)))