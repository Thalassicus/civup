--· ES_ES/MapPins.sql
INSERT INTO Civup_Language_ES_ES (DateModified, Tag, Text, Gender, Plurality) VALUES (date('2013-04-07'), 'TXT_KEY_MAPPINS_CONTEXT_EDIT', 'Editar', '', '');
INSERT INTO Civup_Language_ES_ES (DateModified, Tag, Text, Gender, Plurality) VALUES (date('2013-04-07'), 'TXT_KEY_MAPPINS_CONTEXT_MOVE', 'Mover', '', '');
INSERT INTO Civup_Language_ES_ES (DateModified, Tag, Text, Gender, Plurality) VALUES (date('2013-04-07'), 'TXT_KEY_MAPPINS_CONTEXT_DELETE', 'Eliminar', '', '');
INSERT INTO Civup_Language_ES_ES (DateModified, Tag, Text, Gender, Plurality) VALUES (date('2013-04-07'), 'TXT_KEY_MAPPINS_POPUP_EDIT_TITLE', 'Ingresa detalles al marcador', '', '');
...
INSERT INTO Civup_Language_ES_ES (DateModified, Tag, Text, Gender, Plurality) VALUES (date('2013-04-07'), 'TXT_KEY_MAPPINS_LIST_TYPE', 'Tipo', '', '');
INSERT INTO Civup_Language_ES_ES (DateModified, Tag, Text, Gender, Plurality) VALUES (date('2013-04-07'), 'TXT_KEY_MAPPINS_LIST_SORT_TYPE', 'Ordenar por tipo', '', '');
INSERT INTO Civup_Language_ES_ES (DateModified, Tag, Text, Gender, Plurality) VALUES (date('2013-04-07'), 'TXT_KEY_MAPPINS_LIST_TEXT', 'Notas', '', '');
INSERT INTO Civup_Language_ES_ES (DateModified, Tag, Text, Gender, Plurality) VALUES (date('2013-04-07'), 'TXT_KEY_MAPPINS_LIST_SORT_TEXT', 'Ordenar por notas', '', '');
INSERT INTO Civup_Language_ES_ES (DateModified, Tag, Text, Gender, Plurality) VALUES (date('2013-04-07'), 'TXT_KEY_MAPPINS_LIST_TOGGLE_TT', 'Mostrar/Ocultar marcadores', '', '');
...
INSERT INTO Civup_Language_ES_ES (DateModified, Tag, Text, Gender, Plurality) VALUES (date('2013-04-07'), 'TXT_KEY_TERRAIN_MAP_PINS_HEADING3_TITLE', 'Marcadores de mapa', '', '');
