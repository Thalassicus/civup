...
CityNonGarrisonOffset = Vector2( 60, -39 );
EscortOffset = Vector2( -20, 0 );
EscortOtherOffset = Vector2( 20, 0 );
...
g_UnitFlagClass =  --@was: local -- Modified by Erendir
{
	...
	UpdateFlagOffset = function( self )
        ...
        if self.m_CarrierFlag then
            offset = VecAdd( offset, EscortOtherOffset );
			self.m_CarrierFlag:UpdateFlagOffset( EscortOffset );
