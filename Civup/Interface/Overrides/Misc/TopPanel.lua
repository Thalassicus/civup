...
function HappinessTipHandler( control )
	...
	local iBuildingHappiness = activePlayer:GetHappinessFromBuildings() - City_GetNumBuilding(activePlayer:GetCapitalCity(), GameInfo.Buildings.BUILDING_HAPPINESS_GLOBAL.ID);
