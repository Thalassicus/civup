...
local g_iPeaceDuration = Game.GetPeaceDuration and Game.GetPeaceDuration() or 0;
...
--AttilaMod+
--Make duration the remaining turns if the deal is current
		if(finalTurn > iGameTurn) then
			duration = finalTurn - iGameTurn;
		end
--AttilaMod-
